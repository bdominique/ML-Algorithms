"""
A Python program to implement a adaptive Hinge Loss Algorithm,
The uses a dynamic learning value [1, .1, .01, .001, .0001,
.00001, .000001, .0000001, .00000001, .000000001, .0000000001, .00000000001 ]
instead of a static .001.
"""
import sys
import random
import numpy as np
